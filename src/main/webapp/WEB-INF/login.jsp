...
<body>
    ...
    <div class="container rounded-4 bg-light mt-5 p-4 shadow " style="width: 500px">
        ...
        <form action=" " method="GET ">
            ...
            <div class="mx-5 my-4 ">
                ...
                <div class="input-group">
                    ...
                    <input type="text " class="form-control rounded-end " id="username " placeholder="Username ">
            ...
            <div class="mx-5 my- ">
                ...
                <div class="input-group ">
                    ...
                    <input type="password " class="form-control rounded-end " id="password " placeholder="Password ">
                </div>
            </div>

            <div class="text-end mx-5 my-3 ">
                <a class="link-danger " href="forget-pass ">Fogot Password?</a>
            </div>
            <!-- Login -->
